...
export const MenuToggle = ({ toggle, isDarkMode = false }: { toggle(): void, isDarkMode: boolean }) => (
  ...
  >
    <svg width="23" height="23" viewBox="0 0 23 18">
      <Path isDarkMode={isDarkMode} variants={{ closed: { d: 'M 2 2.5 L 20 2.5' }, open: { d: 'M 3 16.5 L 17 2.5' } }} />
      <Path isDarkMode={isDarkMode} d="M 2 9.423 L 20 9.423" variants={{ closed: { opacity: 1 }, open: { opacity: 0 } }} transition={{ duration: 0.1 }} />
